...
public class CircularBufferTest
{
  ...
  {
    try {
      final int size = 1 + MAX_SIZE;
      CircularBuffer<Integer> instance = new CircularBuffer<Integer>(size);
      fail(String.format("Error: size = %d did not fail", size));
  ...
  */
  ...
  public void testSize()
  {
    ...
    final int max_size = MAX_SIZE >> 1;      // MAX_SIZE runs out of memory
